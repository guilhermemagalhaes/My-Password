...
using MyPassword.Services.Impl;

namespace MyPassword.Presentation
{
    public class Startup
    {
        ...
        {
            var s = services.AddControllersWithViews();

#if (DEBUG)
            s.AddRazorRuntimeCompilation();
#endif

            services.AddDbContext<MyPasswordContext>(options =>
                options.UseSqlServer(Configuration.GetConnectionString("MyPasswordContext")));
